...
public class SaveEventListener {
  ...
  @KafkaListener(topics = "#{T(com.pyokemon.common.kafka.KafkaTopicConstants).EVENT_SAVED_UPDATED}",
  ...
  public void handleSaveEvent(SaveEventKafkaDto event) {
    ...
    log.info("[event-saved-updated] Received event: eventId={}, accountId={}, title={}", eventId,
        accountId, title);
