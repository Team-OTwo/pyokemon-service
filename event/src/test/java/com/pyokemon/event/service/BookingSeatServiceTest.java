...
class BookingSeatServiceTest {
    ...
    void 예약된_좌석이_표시됨() {
        ...
        Booking booked = Booking.builder()
                .seatId(1L)
                .eventScheduleId(scheduleId)
                .status(Booking.Booked.valueOf("BOOKED"))
                .build();
    ...
    void 좌석등급별_남은좌석_수_정상조회() {
        ...
        Price vipPrice = Price.builder()
                .eventScheduleId(scheduleId)
                .seatClassId(10L)
                .price(198000)
                .build();

        Price rPrice = Price.builder()
                .eventScheduleId(scheduleId)
                .seatClassId(20L)
                .price(178000)
                .build();
        ...
        when(bookingRepository.findByEventScheduleIdAndStatus(eq(scheduleId), eq(Booking.Booked.BOOKED)))
                .thenReturn(List.of(booked));
