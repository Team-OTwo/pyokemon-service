...
public final class DidErrorCodes {
    ...
    // Device Connection 관련 에러
    public static final String DEVICE_CONNECTION_CREATION_FAILED = "DEVICE_CONNECTION_CREATION_FAILED";
    public static final String DEVICE_CONNECTION_NOT_FOUND = "DEVICE_CONNECTION_NOT_FOUND";
    public static final String DEVICE_CONNECTION_INVALID = "DEVICE_CONNECTION_INVALID";
