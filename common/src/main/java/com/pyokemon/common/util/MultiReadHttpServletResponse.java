...
public class MultiReadHttpServletResponse extends HttpServletResponseWrapper {
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        ...
        if (servletOutputStream == null) {
            servletOutputStream = new MultiReadServletOutputStream(byteArrayOutputStream, super.getOutputStream());
        }
    ...
    public PrintWriter getWriter() throws IOException {
        ...
        if (printWriter == null) {
            servletOutputStream = new MultiReadServletOutputStream(byteArrayOutputStream, super.getOutputStream());
            printWriter = new PrintWriter(new OutputStreamWriter(servletOutputStream, getCharacterEncoding()));
        }
        return printWriter;
    }
    ...
    private static class MultiReadServletOutputStream extends ServletOutputStream {
        ...
        public MultiReadServletOutputStream(ByteArrayOutputStream byteArrayOutputStream, ServletOutputStream originalOutputStream) {
