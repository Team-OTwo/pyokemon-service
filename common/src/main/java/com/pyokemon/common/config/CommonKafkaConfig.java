...
public class CommonKafkaConfig {
  ...
  public static <T> ConsumerFactory<String, T> createConsumerFactory(String bootstrapServers,
      String groupId, Class<T> valueType, String... trustedPackages) {
    return createConsumerFactory(bootstrapServers, groupId, valueType, null, trustedPackages);
  }

  public static <T> ConsumerFactory<String, T> createConsumerFactory(String bootstrapServers,
      String groupId, Class<T> valueType, Map<String, Object> additionalConfig,
