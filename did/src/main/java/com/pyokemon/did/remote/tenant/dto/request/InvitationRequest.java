  ...
  public static class AcaPyCreateInvitationRequest {
    ...
    public static AcaPyCreateInvitationRequest generate(Long eventId) {
      return AcaPyCreateInvitationRequest.builder()
          .accept(List.of("didcomm/aip1", "didcomm/aip2;env=rfc19")).alias("invitation:" + eventId)
          .goal("To create OOB invitation with event_id: " + eventId).goal_code("issue-vc")
          .handshakeProtocols(List.of("https://didcomm.org/didexchange/1.0"))
          .myLabel("invitation:" + eventId).protocolVersion("1.1").useDidMethod("did:peer:2")
          .usePublicDid(false).build();
    }
  }
