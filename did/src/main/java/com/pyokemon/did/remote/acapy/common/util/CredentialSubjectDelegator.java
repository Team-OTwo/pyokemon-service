...
public final class CredentialSubjectDelegator {
     ...
     */
    public static CredentialSubject extractCredentialSubject(GetCredentialResponse credentialResponse) throws BusinessException {
        if (credentialResponse == null) {
            throw new BusinessException("자격 증명 응답이 null입니다.", VC_INVALID);
        }
        
        try {
            return credentialResponse.getByFormat()
                    .getCredOffer()
                    .getLdProof()
                    .getCredential()
     ...
     * @throws BusinessException 응답이 유효하지 않은 경우
     */
    public static String extractCredentialId(GetCredentialResponse credentialResponse) throws BusinessException {
        if (credentialResponse == null) {
            throw new BusinessException("자격 증명 응답이 null입니다.", VC_INVALID);
        }
     ...
     */
    public static CredentialSubject delegateTo(String delegateeDid, GetCredentialResponse credentialResponse) {
        try {
