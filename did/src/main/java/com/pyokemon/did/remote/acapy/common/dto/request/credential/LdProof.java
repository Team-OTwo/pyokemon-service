...
public class LdProof {
  ...
  public static LdProof withStandardCredential(StandardCredential credential) {
    return LdProof.builder().credential(credential).options(LdProofOptions.createDefault()).build();
  }
  ...
  public static class LdProofOptions {
    ...
    public static LdProofOptions createDefault() {
      return LdProofOptions.builder().proofType(AcaPyConstants.Credential.PROOF_TYPE_ED25519)
          .build();
    }
  }
