...
@RestController
@Slf4j
@RequestMapping("/backend/provision")
...
public class ProvisionController {
     ...
     */
    @PostMapping("/wallet")
    public ResponseEntity<ResponseDto<Void>> provisionWallet(@RequestBody @Valid WalletMetadataRequest.ProvisionWalletRequest requestDto) {
        walletMetadataService.provisionWallet(requestDto);
