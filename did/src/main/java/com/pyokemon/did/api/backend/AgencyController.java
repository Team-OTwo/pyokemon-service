...
public class AgencyController {
   ...
   */
  @PostMapping("/wallet")
  public ResponseEntity<ResponseDto<Void>> createWallet(
      @RequestBody @Valid CreateWalletRequest requestDto) {
    walletMetadataService.createWallet(requestDto);
    return ResponseEntity.status(HttpStatus.CREATED).body(ResponseDto.success("OK"));
  }
  ...
  public ResponseEntity<ResponseDto<Void>> createEventInvitation(
      @RequestBody @Valid CreateEventInvitationRequest requestDto) {
