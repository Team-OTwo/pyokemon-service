...
public class UserWebhookServiceImpl implements UserWebhookService {
    ...
    private DeviceConnection findDeviceConnection(String connectionId, String alias) {
        ...
        Optional<DeviceConnection> byConnectionId = deviceConnectionRepository.findByConnectionId(connectionId);
        ...
        try {
            ...
            return deviceConnectionRepository.findByAlias(systemAlias)
                    .orElseThrow(() -> new BusinessException(
                        "❌ DeviceConnection not found for connection_id: " + connectionId + " or alias: " + systemAlias,
            ...
            throw new BusinessException(
                "❌ DeviceConnection not found for connection_id: " + connectionId + " and could not extract alias from: " + alias,
                "DEVICE_CONNECTION_NOT_FOUND"
            );
        }
    }
