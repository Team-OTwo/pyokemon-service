...
public class AcaPyConnectionServiceImpl implements AcaPyConnectionService {
  ...
  private void receiveInvitation(Wallet userWallet, CreateInvitationResponse invitation,
    ...
    ReceiveInvitationResponse receivedInvitation = remoteUserAcaPyService.receiveInvitation(
        userWallet.getToken(), ReceiveInvitationRequest.fromInvitation(invitation.getInvitation()));
