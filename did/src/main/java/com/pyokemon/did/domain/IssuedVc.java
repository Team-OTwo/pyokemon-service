...
public class IssuedVc extends BaseEntity {
  ...
  public enum VcStatus {
    PROPOSAL_SENT, PROPOSAL_RECEIVED, OFFER_SENT, OFFER_RECEIVED, REQUEST_SENT, REQUEST_RECEIVED, CREDENTIAL_ISSUED, CREDENTIAL_RECEIVED, CREDENTIAL_ACKED, FAILED, ABANDONED
  }
}
