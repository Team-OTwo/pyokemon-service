...
// import
// com.pyokemon.did.remote.commonAcaPy.dto.request.InvitationRequest.AcaPyCreateInvitationRequest;
// import
// com.pyokemon.did.remote.commonAcaPy.dto.response.InvitationResponse.AcaPyCreateInvitationResponse;
// import
// com.pyokemon.did.remote.commonAcaPy.dto.response.InvitationResponse.AcaPyReceiveInvitationResponse;
...
// when(remoteTenantAcaPyService.acaPyCreateInvitation(eq(TOKEN),
// any(AcaPyCreateInvitationRequest.class)))
...
// verify(remoteTenantAcaPyService).acaPyCreateInvitation(eq(TOKEN),
// any(AcaPyCreateInvitationRequest.class));
//
// ArgumentCaptor<AcaPyConnection> acaPyConnectionCaptor =
// ArgumentCaptor.forClass(AcaPyConnection.class);
...
// verify(remoteTenantAcaPyService, never()).acaPyCreateInvitation(anyString(),
// any(AcaPyCreateInvitationRequest.class));
// verify(acaPyConnectionRepository, never()).save(any(AcaPyConnection.class));
// verify(remoteUserAcaPyService, never()).acaPyReceiveInvitation(anyString(),
...
// verify(tenantWalletService).getWalletByTenantId(TENANT_ID);
// verify(userWalletRepository).findByUserId(USER_ID);
// verify(remoteTenantAcaPyService, never()).acaPyCreateInvitation(eq(TOKEN),
// any(AcaPyCreateInvitationRequest.class));
// verify(acaPyConnectionRepository, never()).save(any(AcaPyConnection.class));
// verify(remoteUserAcaPyService, never()).acaPyReceiveInvitation(anyString(),
// any(Invitation.class));
