...
public class WalletMetadataServiceTest {
  ...
  private final WalletMetadataRequest.CreateWalletRequest request =
      new WalletMetadataRequest.CreateWalletRequest(TENANT_ID);
  ...
  void createWallet_Success() {
    ...
    when(remoteTenantAcaPyService
        .acaPyCreateWallet(any(WalletRequest.AcaPyCreateWalletRequest.class)))
    ...
    verify(remoteTenantAcaPyService)
        .acaPyCreateWallet(any(WalletRequest.AcaPyCreateWalletRequest.class));
