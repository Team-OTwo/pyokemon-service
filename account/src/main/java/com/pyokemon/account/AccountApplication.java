...
@ComponentScan(basePackages = {"com.pyokemon.common", "com.pyokemon.common.exception"})
@MapperScan({"com.pyokemon.account.auth.repository", "com.pyokemon.account.tenant.repository",
    ...
    "com.pyokemon.account.user.bff.repository", "com.pyokemon.account.tenant.bff.repository"})
