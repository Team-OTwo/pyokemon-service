...
class SimpleEndpointTest {
  ...
  void controllerClassExists() {
    try {
      Class<?> authController = Class.forName("com.pyokemon.tenant.api.controller.TenantAuthController");
      Class<?> tenantController = Class.forName("com.pyokemon.tenant.api.controller.TenantController");
  ...
  void dtoClassExists() {
    try {
      ...
      Class<?> responseDto = Class.forName("com.pyokemon.tenant.api.dto.response.TenantDetailResponseDto");
  ...
  void loginEndpointHttpTest() {
    try {
      HttpRequest request = HttpRequest.newBuilder()
          .uri(URI.create(BASE_URL + "/tenants/api/tenants/auth/login"))
