...
class TenantServiceTest {
    ...
    class CreateTenantTest {
        ...
        void createTenant_Success() {
            ...
            given(tenantRepository.existsByCorpId(testCreateRequest.getCorpId())).willReturn(false);
        ...
        void createTenant_DuplicateBusinessNumber() {
            // given
            given(tenantRepository.existsByLoginId(testCreateRequest.getLoginId())).willReturn(false);
            given(tenantRepository.existsByCorpId(testCreateRequest.getCorpId())).willReturn(true);
